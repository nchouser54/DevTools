...
variable "workspace_name" {
  ...
  default     = "eks-bedrock-chatbot-rag"
}
...
variable "irsa_role_arn" {
  type        = string
  description = "ARN of the IRSA IAM role for the workload ServiceAccount. See docs/iam-policies/bedrock-chatbot-rag-irsa-policy.json."
  sensitive   = true
}
...
locals {
  ...
  template_tags = ["eks", "bedrock", "rag", "chatbot", "knowledge-bases", "opensearch"]
}
